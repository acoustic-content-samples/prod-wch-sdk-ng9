...
// @public
export function assertProvider<T>(aValue: T, aContext: Context<T>): NonNullable<T>;
...
export interface InjectableReactProviderFactory {
    // (undocumented)
    <T>(fct: () => T, ctx: Context<T>): ReactProvider<T>;
    // (undocumented)
    <R1, T>(fct: (req: [R1]) => T, ctx: Context<T>, req: [Context<R1>]): ReactProvider<T>;
    // (undocumented)
    <R1, R2, T>(fct: (req: [R1, R2]) => T, ctx: Context<T>, req: [Context<R1>, Context<R2>]): ReactProvider<T>;
    // (undocumented)
    <R1, R2, R3, T>(fct: (req: [R1, R2, R3]) => T, ctx: Context<T>, req: [Context<R1>, Context<R2>, Context<R3>]): ReactProvider<T>;
    // (undocumented)
