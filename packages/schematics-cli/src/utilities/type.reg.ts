...
const ELEMENTS_PATH = normalize('elements');
...
function _getPathForType(aType: AuthoringType, aOptions: TypeOptions): Path {
...
function _getTypePath(aType: AuthoringType, aOptions: TypeOptions): Path {
  // join
  return join(ELEMENTS_PATH, _getPathForType(aType, aOptions));
}
