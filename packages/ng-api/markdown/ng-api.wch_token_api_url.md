...
[Home](./index.md) &gt; [@acoustic-content-sdk/ng-api](./ng-api.md) &gt; [WCH\_TOKEN\_API\_URL](./ng-api.wch_token_api_url.md)

## WCH\_TOKEN\_API\_URL variable
...
```typescript
WCH_TOKEN_API_URL: InjectionToken<HubInfoUrlProvider>
```
