...
[Home](./index.md) &gt; [@acoustic-content-sdk/ng-api](./ng-api.md) &gt; [WCH\_TOKEN\_BASE\_URL](./ng-api.wch_token_base_url.md)

## WCH\_TOKEN\_BASE\_URL variable
...
```typescript
WCH_TOKEN_BASE_URL: InjectionToken<HubInfoUrlProvider>
```
