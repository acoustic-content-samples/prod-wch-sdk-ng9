...
[Home](./index.md) &gt; [@acoustic-content-sdk/ng-api](./ng-api.md) &gt; [WCH\_TOKEN\_RESOURCE\_URL](./ng-api.wch_token_resource_url.md)

## WCH\_TOKEN\_RESOURCE\_URL variable
...
```typescript
WCH_TOKEN_RESOURCE_URL: InjectionToken<HubInfoUrlProvider>
```
