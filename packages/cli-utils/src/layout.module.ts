...
import { isNgModuleDecorator } from './ast.utils';
import {
...
function isModule(aStatement: Statement): aStatement is ClassDeclaration {
  // must be a class declaration
  return (
    isClassDeclaration(aStatement) &&
    isNotNil(aStatement.decorators) &&
